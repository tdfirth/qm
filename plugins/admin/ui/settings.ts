...
export { configureCredentials, credentialState, credentialStatus, loadCredentials } from "./settings-credentials.ts";
...
export { configureBranding, applyAccent } from "./settings-branding.ts";
  ...
  for (const [key, s] of states) {
    ...
    if (key === "branding") {
      s.draft = {
        ...
        theme: data.branding?.theme || { mode: "system" },
