...
const built = buildApp(testConfig({ dataDir: tmpDir("webui-cron-") }));
const core = serveApp(built.app, { signingSecret: SECRET, scheduler: built.scheduler });

process.env.CORE_API_URL = core.base;
